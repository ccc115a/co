...
class Or16Chip {
  constructor() {
    ...
    this._p8 = new OrChip();
    this._p9 = new OrChip();
    this._p10 = new OrChip();
    this._p11 = new OrChip();
    this._p12 = new OrChip();
    this._p13 = new OrChip();
    this._p14 = new OrChip();
    this._p15 = new OrChip();
  }
  eval(a, b) {
    let w_out = 0;
    { // part 0: Or (OrChip)
...
class CPUChip {
  constructor() {
    this._p0 = new Or16Chip();
    this._p1 = new NotChip();
    this._p2 = new AndChip();
    this._p3 = new OrChip();
    this._p4 = new Mux16Chip();
    this._p5 = new RegChip();
    this._p6 = new AndChip();
    this._p7 = new RegChip();
    this._p8 = new Mux16Chip();
    this._p9 = new ALUChip();
    this._p10 = new OrChip();
    this._p11 = new NotChip();
    this._p12 = new AndChip();
    this._p13 = new AndChip();
    this._p14 = new AndChip();
    this._p15 = new OrChip();
    this._p16 = new OrChip();
    this._p17 = new AndChip();
    this._p18 = new PCChip();
    this._p19 = new AndChip();
  }
  eval(inM, instruction, reset) {
    ...
    let w_pc = 0;
    let w_writeM = 0;
    { // part 0: Or16 (Or16Chip)
      let __i0 = 0x0;
      let __i1 = instruction;
      const __o = this._p0.eval(__i0, __i1);
      w_isC = setBits(w_isC, 0, 1, ((__o.out >> 15) & 0x1));
      w_a = setBits(w_a, 0, 1, ((__o.out >> 12) & 0x1));
      w_c1 = setBits(w_c1, 0, 1, ((__o.out >> 11) & 0x1));
      w_c2 = setBits(w_c2, 0, 1, ((__o.out >> 10) & 0x1));
      w_c3 = setBits(w_c3, 0, 1, ((__o.out >> 9) & 0x1));
      w_c4 = setBits(w_c4, 0, 1, ((__o.out >> 8) & 0x1));
      w_c5 = setBits(w_c5, 0, 1, ((__o.out >> 7) & 0x1));
      w_c6 = setBits(w_c6, 0, 1, ((__o.out >> 6) & 0x1));
      w_d1 = setBits(w_d1, 0, 1, ((__o.out >> 5) & 0x1));
      w_d2 = setBits(w_d2, 0, 1, ((__o.out >> 4) & 0x1));
      w_d3 = setBits(w_d3, 0, 1, ((__o.out >> 3) & 0x1));
      w_j1 = setBits(w_j1, 0, 1, ((__o.out >> 2) & 0x1));
      w_j2 = setBits(w_j2, 0, 1, ((__o.out >> 1) & 0x1));
      w_j3 = setBits(w_j3, 0, 1, ((__o.out >> 0) & 0x1));
    }
    { // part 5: ARegister (RegChip)
      let __i0 = w_Ain;
      let __i1 = w_Aload;
      const __o = this._p5.eval(__i0, __i1);
      w_Aout = setBits(w_Aout, 0, 16, __o.out);
      w_addressM = setBits(w_addressM, 0, 15, ((__o.out >> 0) & 0x7fff));
    }
    { // part 7: DRegister (RegChip)
      let __i0 = w_ALUout;
      let __i1 = w_Dload;
      const __o = this._p7.eval(__i0, __i1);
      w_Dout = setBits(w_Dout, 0, 16, __o.out);
    }
    { // part 18: PC (PCChip)
      let __i0 = w_Aout;
      let __i1 = w_PCload;
      ...
      const __o = this._p18.eval(__i0, __i1, __i2, __i3);
    ...
    { // part 2: And (AndChip)
      ...
      let __i1 = w_d1;
      const __o = this._p2.eval(__i0, __i1);
      w_AluToA = setBits(w_AluToA, 0, 1, ((__o.out >> 0) & 0x1));
    }
    { // part 6: And (AndChip)
      let __i0 = w_isC;
      let __i1 = w_d2;
      const __o = this._p6.eval(__i0, __i1);
      w_Dload = setBits(w_Dload, 0, 1, ((__o.out >> 0) & 0x1));
    }
    { // part 19: And (AndChip)
      let __i0 = w_isC;
      let __i1 = w_d3;
    ...
    { // part 8: Mux16 (Mux16Chip)
      ...
      let __i2 = w_a;
      const __o = this._p8.eval(__i0, __i1, __i2);
      w_AorM = setBits(w_AorM, 0, 16, __o.out);
    }
    { // part 3: Or (OrChip)
      let __i0 = w_isA;
      let __i1 = w_AluToA;
      const __o = this._p3.eval(__i0, __i1);
      w_Aload = setBits(w_Aload, 0, 1, ((__o.out >> 0) & 0x1));
    }
    { // part 9: ALU (ALUChip)
      let __i0 = w_Dout;
      let __i1 = w_AorM;
      ...
      let __i6 = w_c5;
      let __i7 = w_c6;
      const __o = this._p9.eval(__i0, __i1, __i2, __i3, __i4, __i5, __i6, __i7);
    ...
    { // part 4: Mux16 (Mux16Chip)
      ...
      let __i2 = w_isC;
      const __o = this._p4.eval(__i0, __i1, __i2);
      w_Ain = setBits(w_Ain, 0, 16, __o.out);
    }
    { // part 13: And (AndChip)
      let __i0 = w_zr;
      let __i1 = w_j2;
      const __o = this._p13.eval(__i0, __i1);
      w_passEQ = setBits(w_passEQ, 0, 1, ((__o.out >> 0) & 0x1));
    }
    { // part 10: Or (OrChip)
      let __i0 = w_ng;
      let __i1 = w_zr;
      const __o = this._p10.eval(__i0, __i1);
      w_ngzr = setBits(w_ngzr, 0, 1, ((__o.out >> 0) & 0x1));
    }
    { // part 12: And (AndChip)
      let __i0 = w_ng;
      let __i1 = w_j1;
      const __o = this._p12.eval(__i0, __i1);
      w_passLT = setBits(w_passLT, 0, 1, ((__o.out >> 0) & 0x1));
    }
    { // part 11: Not (NotChip)
      let __i0 = w_ngzr;
      const __o = this._p11.eval(__i0);
      w_gt = setBits(w_gt, 0, 1, ((__o.out >> 0) & 0x1));
    }
    { // part 15: Or (OrChip)
      let __i0 = w_passLT;
      let __i1 = w_passEQ;
      const __o = this._p15.eval(__i0, __i1);
      w_passLE = setBits(w_passLE, 0, 1, ((__o.out >> 0) & 0x1));
    }
    { // part 14: And (AndChip)
      let __i0 = w_gt;
      let __i1 = w_j3;
      const __o = this._p14.eval(__i0, __i1);
      w_passGT = setBits(w_passGT, 0, 1, ((__o.out >> 0) & 0x1));
    }
    { // part 16: Or (OrChip)
      let __i0 = w_passLE;
      let __i1 = w_passGT;
      const __o = this._p16.eval(__i0, __i1);
      w_pass = setBits(w_pass, 0, 1, ((__o.out >> 0) & 0x1));
    }
    { // part 17: And (AndChip)
      let __i0 = w_isC;
      let __i1 = w_pass;
      const __o = this._p17.eval(__i0, __i1);
      w_PCload = setBits(w_PCload, 0, 1, ((__o.out >> 0) & 0x1));
    }
    return {
      outM: w_outM,
      writeM: w_writeM,
  ...
  sample(inM, instruction, reset) {
    ...
    }
    {
      ...
      this._p18.sample(__c0, __c1, __c2, __c3);
    }
  }
  tock() {
    this._p0.tock();
  ...
  probe_whole(name) {
    ...
    // part 9: ALU (ALUChip)
    if (name === "ALU") {
      return this._p9.eval(0, 0, 0, 0, 0, 0, 0, 0)["out"];
    }
    // part 10: Or (OrChip)
    if (name === "Or") {
      return this._p10.eval(0, 0)["out"];
    ...
    // part 18: PC (PCChip)
    if (name === "PC") {
      return this._p18.eval(0, 0, 0, 0)["out"];
    }
    // part 19: And (AndChip)
    if (name === "And") {
